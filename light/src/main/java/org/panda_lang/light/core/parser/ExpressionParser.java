...
public class ExpressionParser implements Parser {
    ...
    public ExpressionParser(LightCore lightCore) {
    ...
    public ExpressionRuntime parse(final ParserInfo parserInfo) {
        ...
        final ExpressionCenter expressionCenter = lightCore.getExpressionCenter();
                ...
                if (pattern.match(expressionSource)) {
                    ...
                    return new ExpressionRuntime(expression, null) {
                        ...
                        public Inst get(org.panda_lang.light.core.Ray ray) {
                            ray.script((LightScript) parserInfo.getPandaScript())
                                    .pattern(pattern)
