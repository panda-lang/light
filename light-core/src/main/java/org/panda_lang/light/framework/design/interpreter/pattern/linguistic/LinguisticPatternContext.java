...
public class LinguisticPatternContext implements Context {

    private final Collection<ContextComponent<?>> context;

    private LinguisticPatternContext(Collection<ContextComponent<?>> context) {
        this.context = new HashSet<>(context);
    }

    public LinguisticPatternContext() {
        this(new HashSet<>());
    }
    ...
    */
    ...
    @Override
    public LinguisticPatternContext fork() {
        return new LinguisticPatternContext(context);
    }
